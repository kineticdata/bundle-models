...
public class CatalogAttribute {
    ...
    public static final String FIELD_NAME = "710000074";
    public static final String FIELD_VALUE = "710000073";
    public static final String FIELD_CHARACTER_VALUE = "710000040";
    public static final String FIELD_PARENT_ID = "710000078";
    public static final String FIELD_PARENT_TYPE = "710000011";
    // Specify the valid attributes parent types
    public static final String PARENT_TYPE_CATALOG = "KS_RQT_ServiceCatalog_base";
    // Specify the fields that should be retrieved from form records
    public static final String[] FIELD_IDS = new String[]{
        FIELD_NAME, FIELD_VALUE, FIELD_CHARACTER_VALUE, FIELD_PARENT_ID,
        FIELD_PARENT_TYPE};
    // Specify the fields that should be retrieved from form records
     ...
     * @param entry
     */
    public CatalogAttribute(HelperContext context, SimpleEntry entry) {
     ...
     */
    public static List<CatalogAttribute> find(HelperContext context, String qualification) {
     ...
     */
    public static List<CatalogAttribute> find(
        ...
        // Declare the results
        List<CatalogAttribute> results = new ArrayList();
        ...
        for (SimpleEntry entry : entries) {
            ...
            results.add(new CatalogAttribute(context, entry));
        }
        // Return the results
        return results;
    }
     ...
     */
    public static CatalogAttribute findSingle(HelperContext context, String qualification) {
        // Declare the result
        ...
        if (entry != null) {
            result = new CatalogAttribute(context, entry);
        }
        // Return the result
        return result;
    }
     ...
     * catalog.
     */
    public static List<CatalogAttribute> findByCatalogId(HelperContext context, String catalogId) {
        // Build the qualification String
        String qualification =
            "'"+FIELD_PARENT_TYPE+"'=\""+PARENT_TYPE_CATALOG+"\" AND "+
            "'"+FIELD_PARENT_ID+"'=\""+catalogId+"\"";
